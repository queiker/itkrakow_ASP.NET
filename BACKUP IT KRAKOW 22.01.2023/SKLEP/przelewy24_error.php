...
*/
  ...
  if (strlen($languge)==0) {
      //load language texts
      $tmp = tep_db_query("select directory from " . TABLE_LANGUAGES . " where languages_id = '" . $lng->language['id'] . "'");
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="4" cellpadding="2">
          <tr>
            ...
            <td valign="top" class="main"><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?><br><?php echo TEXT_ERROR; ?><br><br><?php echo TEXT_CONTACT; ?>

...
<body onload="resize();">
<?php if ($products['products_image_pop']== NULL ) {echo tep_image_maxi(DIR_WS_IMAGES . $products['products_image'], $products['products_name'], POPUP_IMAGE_WIDTH, POPUP_IMAGE_HEIGHT); } else {echo tep_image_maxi(DIR_WS_IMAGES . $products['products_image_pop'], $products['products_name'], POPUP_IMAGE_WIDTH, POPUP_IMAGE_HEIGHT); }; ?>
</body>
</html>

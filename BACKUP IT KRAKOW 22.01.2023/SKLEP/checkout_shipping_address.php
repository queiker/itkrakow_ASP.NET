...
function check_form_optional(form_name) {
 ...
 var street_address_dom = form.elements['street_address_dom'].value;
var street_address_mieszkanie = form.elements['street_address_mieszkanie'].value;
  if (firstname == '' && lastname == '' && street_address == '' && street_address_dom == '' && street_address_mieszkanie == '') {
    return true;
  } else {
...
<?php include('includes/body.php'); ?>
    <td width="100%" valign="top"><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>

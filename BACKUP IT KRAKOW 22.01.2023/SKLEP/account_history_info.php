...
<?php include('includes/body.php'); ?>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" class="blrb">
      ...
      <tr>
        <td><div class="main"><b><?php echo sprintf(HEADING_ORDER_NUMBER, $HTTP_GET_VARS['order_id']) . ' <small>(' . $order->info['orders_status'] . ')</small>'; ?></b></td>
	  </tr>
      <tr>
		<td>
			<div class="smallText" style="float: left;"><?php echo HEADING_ORDER_DATE . ' ' . tep_date_long($order->info['date_purchased']); ?></div>
			<div class="smallText" style="float: right;"><?php echo HEADING_ORDER_TOTAL . ' ' . $order->info['total']; ?></div>
		</td>
      </tr>
	  <tr>
		<td>
...
?>
            <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" width="50%"><?php echo '<b>' . HEADING_DELIVERY_ADDRESS . '</b>'; ?></td>
                <td class="main" width="50%"><?php echo '<b>' . HEADING_SHIPPING_METHOD . '</b>'; ?></td>
              </tr>
              <tr>
...
?>
		...
		<tr>
            ...
            <td width="100%" valign="top" class="sepOrder"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main" width="50%"><?php echo '<b>' . HEADING_BILLING_ADDRESS . '</b'; ?></td>
                <td class="main" width="50%"><?php echo '<b>' . HEADING_PAYMENT_METHOD . '</b>'; ?></td>
              </tr>
              <tr>
...
?>
      ...
      <tr>
        <td class="podsumowanie" colspan="4"><table border="0" width="100%" cellspacing="0" cellpadding="2">
<?php

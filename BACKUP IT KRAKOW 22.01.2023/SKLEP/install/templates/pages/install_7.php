...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    <td>
      <p>Wyst±pi³ nastêpuj±cy b³±d:</p>
      <p><div class="boxMe"><b>Plik konfiguracyjny nie istnieje (lub nie mo¿na go nadpisaæ).</b><br><br>Wykonaj nastêpuj±ce zadania (korzystaj±c z klienta FTP - polecam Windows Commander'a, lub bezpo¶rednio na serwerze):
        <ul class="boxMe"><li>cd <?php echo $dir_fs_document_root; ?>includes/</li><li>touch configure.php</li> lub <li>chmod 706 configure.php</li></ul>
        <ul class="boxMe"><li>cd <?php echo $dir_fs_document_root; ?>admin/includes/</li><li>touch configure.php</li> lub <li>chmod 706 configure.php</li></ul></div>
      </p>
      <p class="noteBox">Je¶li <i>chmod 706</i> nie zadzia³a, spróbuj <i>chmod 777</i>.</p>
      <p class="noteBox">Je¶li instalujesz sklep na serwerze dzia³aj±cym na platformie Windows zmieñ nazwê istniej±cego pliku configure.php na inn±, co pozwoliæ stworzyæ nowy plik.</p>
    </td>
  </tr>
</table>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><a href="index.php"><img src="images/button_cancel.gif" border="0" alt="Anuluj"></a></td>
    <td align="center"><input type="image" src="images/button_retry.gif" border="0" alt="Powtórz"></td>
  </tr>
</table>
...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    <td>Gratulacje ! Instalacja sklepu internetowego <br>zosta³a <b>ZAKOÑCZONA SUKCESEM</B>.<br> ¯yczê mi³ego u¿ytkowania.</td>
 </tr>
</table>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><a href="<?php echo $http_server . $http_catalog . 'index.php'; ?>" target="_blank"><img src="images/button_catalog.gif" border="0" alt="Sklep internetowy"></a></td>
    <td align="center"><a href="<?php echo $http_server . $http_catalog . 'admin/index.php'; ?>" target="_blank"><img src="images/button_administration_tool.gif" border="0" alt="Panel administracyjny"></a></td>
  </tr>
</table>

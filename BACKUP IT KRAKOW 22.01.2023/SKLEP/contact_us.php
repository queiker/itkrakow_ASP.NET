 ...
 <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main"><?php echo 'Thank you for your enquiry'; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
...
<?php if ($enquiry == '')
       { ?>
<tr>
  <td align="right" class="buttons"><?php echo tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td>
</tr>

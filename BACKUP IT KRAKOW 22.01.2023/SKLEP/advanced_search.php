...
?>
      <tr>
		<td class="smalltext" colspan="2"><br /><?php
			echo tep_draw_input_field('keywords', BOX_SEARCH_TEXT, 'style="width: 100%" onFocus="javascript: if(this.value=\''.BOX_SEARCH_TEXT.'\') this.value=\'\'"');?>
	  </tr>
	  <tr>
		<td class="smalltext"><div style="float: left"><?php
			echo tep_draw_checkbox_field('inc_subcat', '1', true) . ' ' . ENTRY_INCLUDE_SUBCATEGORIES; ?>
			</div><div style="float: right">
			<?php
			echo tep_draw_checkbox_field('search_in_description', '1') . ' ' . TEXT_SEARCH_IN_DESCRIPTION;?>&nbsp;</div></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td class="fieldKey" align="right"><?php echo ENTRY_CATEGORIES; ?> &nbsp;</td>
                <td class="fieldValue"><?php echo tep_draw_pull_down_menu('categories_id', tep_get_categories(array(array('id' => '', 'text' => TEXT_ALL_CATEGORIES_SHORT))),'','style="width: 128px;"'); ?></td>
                <td class="fieldKey" align="right"><?php echo ENTRY_MANUFACTURERS; ?> &nbsp;</td>
                <td class="fieldValue"><?php echo tep_draw_pull_down_menu('manufacturers_id', tep_get_manufacturers(array(array('id' => '', 'text' => TEXT_ALL_MANUFACTURERS_SHORT))),'','style="width: 128px;"'); ?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="fieldKey" align="right"><?php echo ENTRY_PRICE_FROM; ?> &nbsp;</td>
                <td class="fieldValue"><?php echo tep_draw_input_field('pfrom'); ?></td>
                <td class="fieldKey" align="right"><?php echo ENTRY_PRICE_TO; ?> &nbsp;</td>
              ...
              <tr>
                <td class="fieldKey" align="right"><?php echo ENTRY_DATE_FROM; ?> &nbsp;</td>
                ...
                <td class="fieldKey" align="right"><?php echo ENTRY_DATE_TO; ?> &nbsp;</td>

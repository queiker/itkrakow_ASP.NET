<?php
/*
  $Id: address_book_details.php,v 1.11 2003/06/09 22:49:56 hpdl Exp $
...
?>
 ...
 <tr>
            ...
            <td class="main"><?php echo tep_draw_input_field('street_address_dom', $entry['entry_street_address_dom']) . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_DOM_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_DOM_TEXT . '</span>': ''); ?></td>
          </tr>
 <tr>
            <td class="main"><?php echo ENTRY_STREET_ADDRESS_MIESZKANIE; ?></td>
            <td class="main"><?php echo tep_draw_input_field('street_address_mieszkanie', $entry['entry_street_address_mieszkanie']) . '&nbsp;' . (tep_not_null(ENTRY_STREET_MIESZKANIE_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_MIESZKANIE_TEXT . '</span>': ''); ?></td>
          </tr>

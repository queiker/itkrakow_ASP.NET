...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
	<tr>
		...
		<td align="center" class="tableHeading"><?php echo ''; ?></td>
...
if (tep_db_num_rows($reviews)) {
	...
	while ($reviews_values = tep_db_fetch_array($reviews)) {
		...
		echo '<td align="center" class="smallText">' . '</td>' . "\n";//. tep_image(DIR_WS_IMAGES . 'stars_' . $reviews_values['reviews_rating'] . '.gif', sprintf(TEXT_OF_5_STARS, $reviews_values['reviews_rating'])) . '</td>' . "\n";

...
?>
 ...
 <tr>
    ...
    <td class="main"><?php echo tep_draw_input_field('street_address_dom') . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_DOM_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_DOM_TEXT . '</span>': ''); ?></td>
  </tr>
 <tr>
    <td class="main"><?php echo ENTRY_STREET_ADDRESS_MIESZKANIE; ?></td>
    <td class="main"><?php echo tep_draw_input_field('street_address_mieszkanie') . '&nbsp;' . (tep_not_null(ENTRY_STREET_ADDRESS_MIESZKANIE_TEXT) ? '<span class="inputRequirement">' . ENTRY_STREET_ADDRESS_MIESZKANIE_TEXT . '</span>': ''); ?></td>
  </tr>
...
?>
  <tr>
    ...
    <td class="main"><?php echo tep_get_country_list('country',$country,'onChange="return refresh_form(checkout_address);"') . '&nbsp;' . 

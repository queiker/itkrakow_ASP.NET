...
<!-- manufacturers //-->
          <tr>
            <td class="bgp"><div id="box_producenci"><?php //BOX_HEADING_MANUFACTURERS

	echo '<div class="headPosW">'.BOX_HEADING_MANUFACTURERS.'</div>';
	echo '<div class="mainPosW">';
...
// Display a drop-down
    ...
    new infoBoxClear($info_box_contents);
?></div>
				</div>
            </td>
          </tr>

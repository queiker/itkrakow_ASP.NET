...
?>
				<td class="dataTableContent"><?php echo '<a href="javascript:popupImageWindow(\'' . FILENAME_POPUP_IMAGE . '?banner=' . $banners['banners_id'] . '\')">' . tep_image(DIR_WS_CATALOG_IMAGES . $banners['banners_image'],ICON_PREVIEW,75,35) . '</a>&nbsp;' . $banners['banners_title']; ?></td>

                <td class="dataTableContent" align="right" valign="middle"><?php echo $banners['banners_group']; ?></td>

...
*/
// reczna deaktywacja nawigacyjnego menu rozwijanego
...
// Define the project version
  define('PROJECT_VERSION', 'Mysklep Comfort 2.5 [@osC 2.2-MS2]<br />S/N: <span style="color: #F00">brak</span><br />typ licencji: <span style="color: #F00">brak</span>');
...
// make a connection to the database... now
  tep_db_connect() or die('Nie mozna polaczyc sie z serwerem bazy danych!');

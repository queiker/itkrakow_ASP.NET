...
// Text Mode
	...
	if (basename($PHP_SELF) == 'orders.php' || basename($PHP_SELF) == 'invoice.php') {
...
// Retreive server information
  ...
  function tep_remove_product($product_id) {
    ...
    if ($duplicate_image['total'] < 2 && $additional_image == 0) {
...
function tep_sms($phone, $text, $nadawca){
	include_once(DIR_WS_CLASSES . 'sms.class.php');
	if(!is_object($sms)) $sms = new smsClass;
	return $sms->send($phone, $text, $nadawca);
}

function tep_remove_special_chars($text){
	if(SMS_USE_PL == 'true'){
		$replace_array = array(
			'±' => '%26%23261;', '¡' => '%26%23260;',
			'æ' => '%26%23263;', 'Æ' => '%26%23262;',
			'ó' => '%26%23243;', 'Ó' => '%26%23211;',
			'³' => '%26%23322;', '£' => '%26%23321;',
			'¶' => '%26%23347;', '¦' => '%26%23346;',
			'¿' => '%26%23380;', '¯' => '%26%23379;',
			'¼' => '%26%23378;', '¬' => '%26%23377;',
			'ñ' => '%26%23324;', 'Ñ' => '%26%23323;',
			'ê' => '%26%23281;', 'Ê' => '%26%23280;',
			' ' => '%20', '&nbsp;' => '%20'
		);
	} else {
		$replace_array = array(
	...
	while(list($from, $to) = each($replace_array)){

...
//	$page = (isset($HTTP_GET_VARS['page']) ? $HTTP_GET_VARS['page'] : '1' ); 
  $resetViewed = (isset($HTTP_GET_VARS['resetViewed']) ? $HTTP_GET_VARS['resetViewed'] : '');
  if (tep_not_null($resetViewed)) {
    if ($resetViewed < 1) {
			 ...
			 tep_db_query("update " . TABLE_PRODUCTS_DESCRIPTION . " set products_viewed = 0 where products_id = $resetViewed");
		}
	}
	// End Reset
...
// bof sort
  ...
  switch ($viewedSortOrder) 
  {
      ...
      case "viewed-desc":
          ...
          break;
      default:
          $sortOrderViewed = "pd.products_viewed DESC";
  }
// eof sort
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_PRODUCTS; ?>&nbsp;<a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'viewedSortOrder=name-asc&page=' . $page, 'NONSSL') . '">'.tep_image_button('ic_up.gif').'</a>'; ?>&nbsp;<a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'viewedSortOrder=name-desc&page=' . $page, 'NONSSL') . '">'.tep_image_button('ic_down.gif').'</a>'; ?></td>
                <td class="dataTableHeadingContent" align="center"><?php echo TABLE_HEADING_VIEWED; ?>&nbsp;<a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'viewedSortOrder=viewed-asc&page=' . $page, 'NONSSL') . '">'.tep_image_button('ic_up.gif').'</a>'; ?>&nbsp;<a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'viewedSortOrder=viewed-desc&page=' . $page, 'NONSSL') . '">'.tep_image_button('ic_down.gif').'</a>'; ?></td>
								<!-- Start Reset -->
                <td class="dataTableHeadingContent" align="center"><a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'resetViewed=0&page=' . $page . '&viewedSortOrder='. $viewedSortOrder, NONSSL) . '" style="color: yellow;">'.STATS_CLEAR_ALL.'</a>'; ?>&nbsp;</td>
								<!-- End Reset -->
              </tr>
<?php
...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href='<?php echo tep_href_link(FILENAME_CATEGORIES, 'action=new_product_preview&read=only&pID=' . $products['products_id'] . '&origin=' . FILENAME_STATS_PRODUCTS_VIEWED . '?page=' . $HTTP_GET_VARS['page'], 'NONSSL'); ?>'">
                ...
                <td class="dataTableContent" align="center"><?php echo $products['products_viewed']; ?>&nbsp;</td>
								<!-- Start Reset -->
                <td class="dataTableContent" align="center"><a href="<?php echo tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'resetViewed=' . $products['products_id'] . '&page=' . $page . '&viewedSortOrder='. $viewedSortOrder) . '">'.tep_image(DIR_WS_IMAGES.'icon_reset.gif').'</a>'; ?>&nbsp;</td>
								<!-- End Reset -->
              </tr>
<?php
  }

        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td><table border="0" cellspacing="0" cellpadding="3">
              ...
              <tr>
                <td class="smallText"><b><?php echo 'Safe mode'; ?></b></td>
                <td colspan="3" class="smallText"><?php echo ((@ini_get('safe_mode')) ? '<font color="red"><b>tak</b></font>' : 'nie' . ' - <font color="green"><b>OK</b></font>'); ?></td>
              </tr>
<?php
              if (!( function_exists('imagecreatefromjpeg') ))
              {
				echo '<tr><td class="smallText"><font color="red"><b>imagecreatefromjpeg()</b></font></td><td colspan="3" class="smallText"><font color="red">funkcja nie istnieje</b></td></tr>';
              } else {
				echo '<tr><td class="smallText"><b>imagecreatefromjpeg()</b></td><td colspan="3" class="smallText">funkcja istnieje, biblioteka GD za³adowana - <font color="green"><b>OK</b></font></td></tr>';
              }
              if ( !( function_exists('imagecreate') ) && !( function_exists('imagecreate') ) )
              {
				echo '<tr><td class="smallText"><font color="red"><b>imagecreate()</b></font></td><td colspan="3" class="smallText"><font color="red">funkcja nie istnieje</b></td></tr>';	
              } else {
				$gd_version = (function_exists('imagecreatetruecolor')) ? 2 : 1;
				echo '<tr><td class="smallText"><b>imagecreate()</b></td><td colspan="3" class="smallText">' . sprintf('funkcja istnieje, biblioteka GD [ver.%s] za³adowana', $gd_version) . ' - <font color="green"><b>OK</b></font></td></tr>';
              }
?>
            </table></td>
          </tr>
...
<?php
    ...
    echo '<table border="1" cellpadding="3" width="600" style="border: 0px; border-color: #000000;">' .
         '  <tr><td align="center"><a href="http://www.oscommerce.com"><img border="0" src="images/oscommerce.gif" alt=" osCommerce " /></a><br /><span style="font-weight: bold; font-family: verdana; font-size: 11px;"> ' . PROJECT_VERSION . '</span></td>' . 
         '  </tr>' .
         '</table>';
    echo $regs[1];
  } else {

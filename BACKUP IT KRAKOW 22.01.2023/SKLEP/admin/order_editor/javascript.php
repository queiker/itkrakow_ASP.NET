  ...
  function obtainTotals() { //this is used for processing/updating order totals
    ...
    for (i=0; i < document.edit_order.elements.length; i++) {
	 ...
	 var url = "<?php echo FILENAME_ORDERS_EDIT_AJAX; ?>";
	  ...
	  //hey- we're busy here
	  document.getElementById("totalsBlock").innerHTML = '<div align="center" class="main" style="border-left: 3px solid green; padding: 5; width: 200px;"><img src="order_editor/images/working.gif"><br><?php echo '£adowanie...'; ?><br></div>';  

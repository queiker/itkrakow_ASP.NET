			...
			WHERE products_id = '" . $_POST['add_product_products_id'] . "'");
             ...
             if (isset($_POST['add_product_options'])) 
			 {
              foreach($_POST['add_product_options'] as $option_id => $option_value_id) 
			  {
			   ...
			   $stock_chk_arr['products_stock_quantity'];
			   // update the stock
			   tep_db_query("update ".TABLE_PRODUCTS_STOCK." set products_stock_quantity = products_stock_quantity - ".$_POST['add_product_quantity']. " where products_id=" . $_POST['add_product_products_id']. " and products_stock_attributes='".$products_stock_attributes."'");
			  } // for loop
			 }
             // update the options stock as well here: End
			}// end of if

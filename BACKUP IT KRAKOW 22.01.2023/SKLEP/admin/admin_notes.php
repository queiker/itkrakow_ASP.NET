...
?>
            <td align="right"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr><?php echo tep_draw_form('search', FILENAME_ADMIN_NOTES, '', 'get'); ?>
                <td class="smallText" align="right"><?php echo HEADING_TITLE_SEARCH . ' ' . tep_draw_input_field('search', $searchquery, "onFocus=\"if (this.value == 'enter search query') { this.value='' }\"").tep_hide_session_id(); ?></td>
              </form></tr>
...
?>                                        
          <tr class="dataTableRow">
            ...
            <td class="dataTableContent"><?php echo tep_draw_input_field('status', $sInfo->status, 'size=2 maxlength=1'); ?>&nbsp;&nbsp;&nbsp;0 = <?php echo tep_image(DIR_WS_IMAGES . 'icon_status_red.gif', 'Wa¿ne', 10, 10); ?> Wa¿ne&nbsp;&nbsp;&nbsp;1 = <?php echo tep_image(DIR_WS_IMAGES . 'icon_status_green.gif', '¦rednie znaczenie', 10, 10); ?> ¦rednie znaczenie&nbsp;&nbsp;&nbsp;2 = <?php echo tep_image(DIR_WS_IMAGES . 'icon_status_yellow.gif', 'Ostro¿nie', 10, 10); ?> Ostro¿nie</td>
          </tr>
<?php
}
?>          
...
<?php
      if ($admin_quer['status'] == '0') {
                echo tep_image(DIR_WS_IMAGES . 'icon_status_red.gif', IMAGE_ICON_MARKER_RED, 10, 10) . '&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=1&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_green_light.gif', IMAGE_ICON_MARKER_GREEN_LIGHT, 10, 10) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=2&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_yellow_light.gif', IMAGE_ICON_MARKER_YELLOW_LIGHT, 10, 10) . '</a>';
      } elseif ($admin_quer['status'] == '1') {
                       echo '<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=0&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.gif', IMAGE_ICON_MARKER_RED_LIGHT, 10, 10) . '</a>&nbsp;' . tep_image(DIR_WS_IMAGES . 'icon_status_green.gif', IMAGE_ICON_MARKER_GREEN, 10, 10) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=2&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_yellow_light.gif', IMAGE_ICON_MARKER_YELLOW_LIGHT, 10, 10) . '</a>';
      } elseif ($admin_quer['status'] == '2') {
                       echo '<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=0&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_red_light.gif', IMAGE_ICON_MARKER_RED_LIGHT, 10, 10) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=1&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_green_light.gif', IMAGE_ICON_MARKER_GREEN_LIGHT, 10, 10) . '</a>&nbsp;<a href="' . tep_href_link(FILENAME_ADMIN_NOTES, 'action=setflag&flag=3&id=' . $admin_quer['contr_id'] . '&page=' . $HTTP_GET_VARS['page'] . '&sID=' . $admin_quer['contr_id'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_status_yellow.gif', IMAGE_ICON_MARKER_YELLOW, 10, 10) . '</a>';
      } else {
...
// BOF readonly
      ...
      $product = tep_db_fetch_array($product_query);
      $sInfo = new objectInfo($product);
      if ($sInfo->status == '0') $status_desc = IMAGE_ICON_MARKER_GREEN;
      if ($sInfo->status == '1') $status_desc = IMAGE_ICON_MARKER_RED;      
      if ($sInfo->status == '2') $status_desc = IMAGE_ICON_MARKER_YELLOW;
      if ($sInfo->status == '3') $status_desc = IMAGE_ICON_MARKER_YELLOW_LIGHT;
?>
      <tr>

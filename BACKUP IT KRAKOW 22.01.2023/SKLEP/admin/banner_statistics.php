...
// check if the graphs directory exists
  ...
  $banner_query = tep_db_query("select banners_title, banners_image from " . TABLE_BANNERS . " where banners_id = '" . (int)$HTTP_GET_VARS['bID'] . "'");
...
?>
      ...
      <tr>
        <td align="center"><?php 
echo tep_image(DIR_WS_CATALOG_IMAGES.$banner['banners_image']);
?>		</td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>

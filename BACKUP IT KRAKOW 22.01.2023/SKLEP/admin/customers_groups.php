  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      case 'update':
		...
		$customers_groups_price = tep_db_prepare_input($HTTP_POST_VARS['customers_groups_price']);
...
<?php
  if ($HTTP_GET_VARS['action'] == 'edit') {
    $customers_groups_query = tep_db_query("select c.customers_groups_id, c.customers_groups_name, c.customers_groups_discount, c.customers_groups_price from " . TABLE_CUSTOMERS_GROUPS . " c  where c.customers_groups_id = '" . $HTTP_GET_VARS['cID'] . "'");

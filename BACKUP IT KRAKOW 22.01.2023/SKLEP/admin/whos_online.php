...
// Images used for status lights
  $status_active_cart = 'icon_status_cart.gif'; // replace word cart with green if you dont want the new icon.
                          ...
                          <td class="dataTableContent" valign="top"><?php
                            ...
                            if (strpos($temp_url_link,'product_info.php')) {
                              ...
                              if ($products_id) {
                                ...
                                $display_link = $product['products_name'].' <i>(Produkt)</i>';
                              } else {
                              ...
                              $display_link = $cat_list.' <i>(Kategoria)</i>';
                            } else {
                              $display_link = $temp_url_display;
                            }

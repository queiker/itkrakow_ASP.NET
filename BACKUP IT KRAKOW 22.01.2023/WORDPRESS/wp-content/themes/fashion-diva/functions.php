    ...
    function fashion_diva_customize_register( $wp_customize ){
        ...
        $wp_customize->add_control(
            new Blossom_Fashion_Toggle_Control( 
                ...
                array(
                    'section'       => 'typography_settings',
                    'label'         => __( 'Load Google Fonts Locally', 'fashion-diva' ),
                    'description'   => __( 'Enable to load google fonts from your own server instead from google\'s CDN. This solves privacy concerns with Google\'s CDN and their sometimes less-than-transparent policies.', 'fashion-diva' )
                )
            )
        );   
        ...
        $wp_customize->add_control(
            new Blossom_Fashion_Toggle_Control( 
                ...
                array(
                    'section'       => 'typography_settings',
                    'label'         => __( 'Preload Local Fonts', 'fashion-diva' ),
                    'description'   => __( 'Preloading Google fonts will speed up your website speed.', 'fashion-diva' ),
        ...
        ob_start(); ?>
            ...
            <span style="margin-bottom: 5px;display: block;"><?php esc_html_e( 'Click the button to reset the local fonts cache', 'fashion-diva' ); ?></span>
            
            <input type="button" class="button button-primary blossom-fashion-flush-local-fonts-button" name="blossom-fashion-flush-local-fonts-button" value="<?php esc_attr_e( 'Flush Local Font Files', 'fashion-diva' ); ?>" />
        <?php
        $fashion_diva_flush_button = ob_get_clean();
        ...
        $wp_customize->add_control(
            'ed_flush_local_fonts',
            array(
                'label'         => __( 'Flush Local Fonts Cache', 'fashion-diva' ),
                'section'       => 'typography_settings',
                'description'   => $fashion_diva_flush_button,
                'type'          => 'hidden',
                'active_callback' => 'blossom_fashion_ed_localgoogle_fonts'
            )
        );
